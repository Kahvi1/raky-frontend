...
export default function HeroSection() {
  return (
    <header className="flex flex-col items-center bg-white text-center px-6 pt-[clamp(5rem,6vw,6rem)] pb-[clamp(1.25rem,3vw,3rem)] max-w-6xl mx-auto">
      <h1 className="text-[clamp(1.7rem,6.8vw,3.8rem)] leading-[1.25] mb-6 font-[600] max-w-[25ch] tracking-[-0.03em]">Bikin Konten Jadi Lebih Praktis<br className='hidden lg:block' />Tanpa Pusing Editing Sendiri</h1> 
      <p className="text-[#6E6E6E] text-[clamp(1.15rem,1.5vw,1.3rem)] max-w-[60ch] mx-auto leading-[1.72] mb-6 md:mb-8">Tim editor kami siap bantu kamu handle TikTok, Reels, sampai YouTube.<br className='hidden lg:block' />Cepat, scalable, dan disesuaikan dengan style kamu. Tanpa antrian, tanpa ribet.</p>
