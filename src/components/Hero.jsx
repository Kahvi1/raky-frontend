...
export default function HeroSection() {
  return (
    <header className="flex flex-col items-center bg-white text-center px-6 pt-[clamp(5rem,6vw,6rem)] pb-[clamp(1.25rem,3vw,3rem)] max-w-6xl mx-auto">
      <h1 className="text-[clamp(1.7rem,6.8vw,3.8rem)] leading-[1] mb-6 font-semibold max-w-[25ch] tracking-[-0.03em]">Bikin Konten Jadi Lebih Praktis Tanpa Harus Pusing Editing Sendiri</h1> 
