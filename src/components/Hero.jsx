...
export default function HeroSection() {
  return (
    <header className="flex flex-col items-center bg-white text-center px-6 pt-[clamp(5rem,6vw,6rem)] pb-[clamp(1.25rem,3vw,3rem)] max-w-6xl mx-auto">
      ...
      <p className="text-[#6E6E6E] text-[clamp(0.9rem,1.5vw,1.3rem)] max-w-[50ch] md:max-w-[60ch] mx-auto leading-[1.72] mb-6 md:mb-8">Tim editor kami siap bantu kamu handle TikTok, Reels, sampai YouTube.<ResponsiveBreak breakpoint='md' />Cepat, scalable, dan disesuaikan dengan style kamu. Tanpa antrian, tanpa ribet.</p>
